...
class BoardLocalization:
    ...
    def callback(self,request):
        ...
        RedBlueButPos, BlueButtonPos, id_red_blue_contour  = getRedBlueButtonsNewVersion2(saturation,b_col,contours_limited,crop_img2, ScreenPos,rgb_frame)
        ...
        blue_button_camera = np.array(self.realsense.deproject(BlueButtonPos[0],BlueButtonPos[0],self.depth))/1000.0
